...
Runway_activity Runway_4::activity(int time, Plane& moving)
/*
...
bool Runway_4::landing_queue_empty()
{
    return mLanding.empty();
}

bool Runway_4::takeoff_queue_empty()
{
    return mTakeoff.empty();
}

Runway_activity Runway_4::landing(int time, Plane& moving)
{
    Runway_activity in_progress;
    if (!mLanding.empty()) {
        mLanding.retrieve(moving);
...
Runway_activity Runway_4::takingoff(int time, Plane& moving)
{
    Runway_activity in_progress;
...
Error_code Runway_4::take_from_takeoff(Plane& movePlane)
{
    Error_code result;
...
Error_code Runway_4::take_from_landing(Plane& movePlane)
{
    Error_code result;
...
void Runway_4::combine(Runway_4& add)
{
...
Extended_queue Runway_4::get_landing()
{
    return mLanding;
}

Extended_queue Runway_4::get_takeoff()
{
    return mTakeoff;
}

int Runway_4::get_land_requests()
{
    return num_land_requests;
}

int Runway_4::get_takeoff_requests()
{
    return num_takeoff_requests;
}

int Runway_4::get_landings()
{
    return num_landings;
}

int Runway_4::get_takeoffs()
{
    return num_takeoffs;
}

int Runway_4::get_landing_accepted()
{
    return num_land_accepted;
}

int Runway_4::get_takeoff_accepted()
{
    return num_takeoff_accepted;
}

int Runway_4::get_landing_refused()
{
    return num_land_refused;
}

int Runway_4::get_takeoff_refused()
{
    return num_takeoff_refused;
}

int Runway_4::get_landing_waiting()
{
    return land_wait;
}

int Runway_4::get_takeoff_waiting()
{
    return takeoff_wait;
}

int Runway_4::get_idle_time()
{
    return idle_time;
}
