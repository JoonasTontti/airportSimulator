...
void Runway::combine(Runway& add)
{
...
Extended_queue Runway::get_landing()
{
    return mLanding;
}

Extended_queue Runway::get_takeoff()
{
    return mTakeoff;
}

int Runway::get_land_requests()
{
    return num_land_requests;
}

int Runway::get_takeoff_requests()
{
    return num_takeoff_requests;
}

int Runway::get_landings()
{
    return num_landings;
}

int Runway::get_takeoffs()
{
    return num_takeoffs;
}

int Runway::get_landing_accepted()
{
    return num_land_accepted;
}

int Runway::get_takeoff_accepted()
{
    return num_takeoff_accepted;
}

int Runway::get_landing_refused()
{
    return num_land_refused;
}

int Runway::get_takeoff_refused()
{
    return num_takeoff_refused;
}

int Runway::get_landing_waiting()
{
    return land_wait;
}

int Runway::get_takeoff_waiting()
{
    return takeoff_wait;
}

int Runway::get_idle_time()
{
    return idle_time;
}
