...
void main_2(){
    ...
    cout << "Activity for runway 1 which was used for landings." << endl;
    landing_runway.shut_down(end_time);

    cout << "Activity for runway 2 which was used for takeoffs." << endl;
    takeoff_runway.shut_down(end_time);

    cout << "Activity for the whole airport" << endl;
    total.combine(takeoff_runway);
